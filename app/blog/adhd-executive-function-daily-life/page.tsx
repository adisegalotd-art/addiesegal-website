...
export const metadata = {
  ...
  description: 'Explore how ADHD impacts executive function and what you can do to build sustainable strategies for daily life.',
};
    ...
    <main className="min-h-screen bg-gradient-to-b from-[#faf8f5] to-white">
      <article className="max-w-2xl mx-auto px-6 py-12">
        ...
        <div className="prose prose-slate max-w-none text-slate-700">
          <p>
            This article is coming soon. Check back shortly for insights into executive function and ADHD.
          </p>
        </div>
